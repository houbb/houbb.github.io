/*Minified convnetjs by Andrej Karpathy*/
...
(function (c) {
    ...
    d.prototype = {
        forward: function (h, k) {
            ...
            e.push({params: this.biases.w, grads: this.biases.dw, l1_decay_mul: 0, l2_decay_mul: 0});
            return e
        }, toJSON: function () {
            var f = {};
            f.sx = this.sx;
...
(function (d) {
    ...
    c.prototype = {
        makeLayers: function (e) {
            b(e.length >= 2, "Error! At least one input layer and one loss layer are required.");
            b(e[0].type === "input", "Error! First layer must be the input layer, to declare size of inputs");
            var f = function () {
                var m = [];
                for (var l = 0; l < e.length; l++) {
                    ...
                    if ((n.type === "fc" || n.type === "conv") && typeof(n.bias_pref) === "undefined") {
                        n.bias_pref = 0;
                        if (typeof n.activation !== "undefined" && n.activation === "relu") {
                            n.bias_pref = 0.1
                        }
                    }
                    m.push(n);
            ...
            b(h.layer_type === "softmax", "getPrediction function assumes softmax as last layer of the net!");
            var j = h.out_act.w;
            var e = j[0];
            var f = 0;
