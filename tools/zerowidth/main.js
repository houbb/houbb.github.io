...
var zeroWidthNonJoiner = "‌",
    ...
    leftToRightMark = "‎",
    rightToLeftMark = "‏",
    zeroWidthDict = { leftToRightMark: leftToRightMark, rightToLeftMark: rightToLeftMark, zeroWidthNonJoiner: zeroWidthNonJoiner, zeroWidthJoiner: zeroWidthJoiner, zeroWidthNoBreakSpace: zeroWidthNoBreakSpace, zeroWidthSpace: zeroWidthSpace },
  ...
  for (var t = "", e = 0; e < r.length; e++) {
    for (var o = r.codePointAt(e), i = o.toString(5), n = "", a = 0; a < i.length; a++) n += Quinary2ZeroMap[+i.charAt(a)];t += (e = o < 65536 ? e : e + 1) === r.length - 1 ? n : n + zeroWidthSpace;
  }return t;
}function z2t(r) {
  var t = "";if (0 === r.length) return t;for (var e = r.split(zeroWidthSpace), o = 0; o < e.length; o++) {
    for (var i = "", n = 0; n < e[o].length; n++) i += Zero2QuinaryMap[e[o].charAt(n)];t += String.fromCodePoint(parseInt(i, 5));
  }return t;
}function encode(r, t) {
  var e = "",
      o = t2z(t);if (0 === r.length) return o;var i = !1,
      n = !0,
      a = !1,
      h = void 0;try {
  ...
  var t = "",
    ...
    for (var a, h = r[Symbol.iterator](); !(o = (a = h.next()).done); o = !0) {
      var c = a.value;Zero2QuinaryMap[c] ? e += c : t += c;
    }
  } catch (r) {
    i = !0, n = r;
  } finally {
...
exports.default = {
  ...
  methods: {
    ...
    toGithub: function toGithub() {
      location.href = 'https://github.com/houbb';
    }
  }
};
