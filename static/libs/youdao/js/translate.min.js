...
(function (c, a) {
    function b() {
        ...
        function g(k) {
            ...
            if (c.browser.msie) {
                l = '<!DOCTYPE html><html><head><meta https-equiv="Content-Type" content="text/html;charset=utf-8" /><link id="linkStyle" rel="stylesheet" type="text/css" href="javascript:void(0)" />'
            } else {
                l = '<!DOCTYPE html><html><head><meta https-equiv="Content-Type" content="text/html;charset=utf-8"/>'
            }
            k.open();
            k.write(l + j);
            k.close()
        ...
        function f(m) {
            var k = "/static/libs/youdao/css/selector.css";
            if (c.browser.msie) {
    ...
    var a = {
        renderTranslation: function (g, d, j) {
            ...
            if (l === 10) {
                ...
                k.setAttribute("href", "https://f.youdao.com/?path=fanyi&vendor=openapi.selector&text=" + encodeURIComponent(e.query));
            ...
            c.setAttribute("href", "https://dict.youdao.com/search?keyfrom=selector&q=" + encodeURIComponent(d.query));
            ...
            c.setAttribute("href", "https://cidian.youdao.com/?keyfrom=dictapi.selector");
            c.setAttribute("target", "_blank");
            ...
            e.setAttribute("href", "https://f.youdao.com/?path=fanyi&vendor=openapi.selector&text=" + encodeURIComponent(g.query));
...
(function (e, a, d, c) {
    function b() {
        ...
        function g() {
            ...
            if (v !== null) {
                ...
                e.css(v, {
                    ...
                    border: 0,
                    padding: 0,
                    backgroundImage: "url(https://shared.ydstatic.com/api/1.0/switcher.png)",
                    width: "20px",
                    height: "40px",
                    cursor: "pointer"
                });
        ...
        function t(w) {
            ...
            x.setAttribute("src", "https://fanyi.youdao.com/openapi.do?type=data&doctype=jsonp&version=1.1&" + e.parameter({
        ...
        function q(w) {
            ...
            var x = document.createElement("script");
            x.setAttribute("type", "text/javascript");
            x.setAttribute("src", "https://fanyi.youdao.com/openapi.do?type=data&only=on&doctype=jsonp&version=1.1&" + e.parameter({
                    relatedUrl: a.relatedUrl,
                    keyfrom: "20170413PersonApi",
                    key: "477661285",
                    callback: y,
