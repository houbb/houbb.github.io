...
本文将介绍如何在 Dubbo Java 实现中自定义调用链路上核心的扩展点以满足您的需求。

![dubbo-architucture](https://cn.dubbo.apache.org/imgs/v3/concepts/invoke-arch.jpg)
...
![filter-architucture](https://cn.dubbo.apache.org/imgs/v3/concepts/filter-arch.jpg)
...
> [调用拦截扩展方式](https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/reference-manual/spi/description/filter/)
...
> [路由选址扩展方式](https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/reference-manual/spi/description/router/)
...
> [集群规则扩展方式](https://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/reference-manual/spi/description/cluster/)
...
https://cn.dubbo.apache.orghttps://cn.dubbo.apache.org/zh-cn/overview/mannual/java-sdk/reference-manual/architecture/service-invocation/
