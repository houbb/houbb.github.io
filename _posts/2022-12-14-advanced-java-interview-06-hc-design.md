---
layout: post 
title: java 知识进阶面试-06-HC 如何设计一个高并发系统？
...
我说的浅显一点，很简单，就是因为刚开始系统都是连接数据库的，但是要知道数据库支撑到每秒并发两三千的时候，基本就快完了。

所以才有说，很多公司，刚开始干的时候，技术比较 low，结果业务发展太快，有的时候系统扛不住压力就挂了。
...
![high-concurrency-system-design.png](https://github.com/doocs/advanced-java/raw/main/docs/high-concurrency/images/high-concurrency-system-design.png)
