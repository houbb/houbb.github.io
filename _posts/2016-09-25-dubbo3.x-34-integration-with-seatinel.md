---
layout: post
title: Dubbo3.x-34-生态集成之 Sentinel 为 Dubbo 服务保驾护航
...
![Dubbo Arch](https://cn.dubbo.apache.org/imgs/architecture.png)
...
![Discovery](https://cn.dubbo.apache.org/imgs/blog/2018/07/27/sentinel/machinediscover.png)
...
![秒级实时监控](https://cn.dubbo.apache.org/imgs/blog/sentinel-dashboard-metrics.png)

*   **规则配置**：可以查看已有的限流、降级和系统保护规则，并实时地进行配置。

![规则配置](https://cn.dubbo.apache.org/imgs/blog/sentinel-dashboard-view-rules.png)
