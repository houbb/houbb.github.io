...
## 详细介绍一下 Awesome ChatGPT Prompts

"Awesome ChatGPT Prompts" 指的是一系列精心设计的提问或指令，它们可以用来引导像我这样的人工智能（AI）进行特定的任务或生成有趣的回答。这些提示可以用于各种目的，包括但不限于娱乐、教育、创意写作、编程、心理学实验等。以下是一些使用 ChatGPT 提示的示例和它们可能的用途：

1. **创意写作**:
   - “写一个关于时间旅行者在古代埃及的短故事。”
   - “为一部科幻电影创造一个独特的外星生物，并描述其特征。”

2. **编程和技术问题**:
   - “解释一下什么是递归，并通过一个简单的例子来展示它。”
   - “如何在 Python 中实现一个简单的网页爬虫？”
...
11. **科学和技术**:
    - “解释一下人工智能如何影响未来的工作市场。”
    - “描述一下量子计算机与传统计算机的主要区别。”

12. **伦理和哲学**:
    - “讨论一下人工智能的伦理问题。”
    - “什么是功利主义，它为什么在伦理学中重要？”

使用这些提示时，重要的是要清晰、具体，并且提供足够的上下文，以便 AI 能够生成最相关和有用的回答。此外，有些提示可能需要 AI 进行搜索或访问外部信息来提供准确的回答。
...
欢迎来到“Awesome ChatGPT Prompts”存储库！这是一个与ChatGPT模型一起使用的提示示例集合。

[ChatGPT](https://chat.openai.com/chat) 模型是由 [OpenAI](https://openai.com) 训练的大型语言模型，能够生成类似人类的文本。通过提供提示，它可以生成继续对话或扩展给定提示的响应。

在这个存储库中，你将找到各种可以与ChatGPT一起使用的提示。

我们鼓励你[添加你自己的提示](https://github.com/f/awesome-chatgpt-prompts/edit/main/README.md)到列表中，并使用ChatGPT生成新的提示。

要开始，只需克隆此存储库，并使用README.md文件中的提示作为ChatGPT的输入。你也可以使用此文件中的提示作为创建你自己提示的灵感。

我们希望你发现这些提示有用，并享受使用ChatGPT的乐趣！

**[在GitHub上查看](https://github.com/f/awesome-chatgpt-prompts)**

**[在Hugging Face上查看](https://huggingface.co/datasets/fka/awesome-chatgpt-prompts/)**

---

### ⭐️ 新：Awesome ChatGPT商店：定制GPT的中心

现在，你可以访问[Awesome ChatGPT商店](https://github.com/devisasari/awesome-chatgpt-store)，这是ChatGPT生态系统中动态的新成员！随着可定制GPT模型的引入，我们的商店提供了一个精选的专门化ChatGPT GPT集合，每个GPT都为独特的应用和用例量身定制。

探索各种GPT，从为特定编程语言优化的GPT，到为创意写作、技术分析等微调的模型。这个存储库不仅仅是一个商店；它是一个社区驱动的平台，开发者和爱好者可以在这里分享、发现并利用ChatGPT多功能性的全部潜力。

深入定制的对话AI模型的世界，并用尖端技术丰富你的项目。现在访问[Awesome ChatGPT商店](https://github.com/devisasari/awesome-chatgpt-store)并开始探索可能性！

---

**下载ChatGPT桌面应用**：**[macOS](https://github.com/lencx/ChatGPT/releases/download/v0.10.1/ChatGPT_0.10.1_x64.dmg)** / **[Windows](https://github.com/lencx/ChatGPT/releases/download/v0.10.1/ChatGPT_0.10.1_x64_en-US.msi)** / **[Linux](https://github.com/lencx/ChatGPT/releases/download/v0.10.1/chat-gpt_0.10.1_amd64.deb)**

> ℹ️ **注：** 有时，一些提示可能不会按预期工作，或者可能被AI拒绝。请重试，开始一个新线程，或者注销然后重新登录。如果这些解决方案不起作用，请尝试用你自己的句子重写提示，同时保持指令相同。

### 想要编写有效的提示吗？

我写了一本免费的电子书，名为 **"The Art of ChatGPT Prompting: A Guide to Crafting Clear and Effective Prompts"**。

📖 **[阅读免费电子书](https://fka.gumroad.com/l/art-of-chatgpt-prompting)** 

### 想要学习如何使用ChatGPT提示赚钱吗？

我写了一本电子书，名为 **"How to Make Money with ChatGPT: Strategies, Tips, and Tactics"**。

📖 **[购买电子书](https://fka.gumroad.com/l/how-to-make-money-with-chatgpt)** 

### 想要保护你的ChatGPT应用吗？

[Utku Şen](https://twitter.com/utkusen) 写了一本电子书，名为 **"Securing GPT: A Practical Introduction to Attack and Defend ChatGPT Applications"**。

📖 **[购买电子书](https://utkusen.gumroad.com/l/securing-gpt-attack-defend-chatgpt-applications)** 

---

## 其他提示资源

### 想要学习如何为Midjourney AI编写图像提示吗？

我写了一本电子书，名为 **"The Art of Midjourney AI: A Guide to Creating Images from Text"**。
...
_非官方的_ ChatGPT桌面应用程序提供了一种方便的方式来访问和使用此存储库中的提示。使用该应用程序，你可以轻松导入所有提示，并使用斜杠命令（例如 `/linux_terminal`）与它们一起使用。这个功能消除了每次想要使用提示时手动复制和粘贴的需要。

> **桌面应用是由 @lencx 的 [非官方开源项目](https://github.com/lencx/ChatGPT)。它是ChatGPT Web界面的简单包装，具有强大的额外功能。**
...
[Merve Noyan](https://huggingface.co/merve) 创建了一个出色的 [ChatGPT提示生成器应用](https://huggingface.co/spaces/merve/ChatGPT-prompt-generator)，允许用户生成针对其期望角色的定制提示。该应用程序使用此存储库作为其训练数据集。

---

### 使用prompts.chat

[prompts.chat](https://prompts.chat) 旨在在使用提示时提供增强的用户体验。只需几次点击，你就可以轻松编辑和复制网站上的提示，以适应你的特定需求和偏好。复制按钮将按照你编辑的确切方式复制提示。
...
## ChatGPT SEO提示
由 [StoryChief AI](https://www.storychief.io/ai-power-mode) 贡献
参考：[https://storychief.io/blog/chatgpt-prompts-seo](https://storychief.io/blog/chatgpt-prompts-seo) 

> 使用 WebPilot，为一篇将基于谷歌前10个结果的关键词“Best SEO Prompts”的2000字文章创建大纲。<br/>
> 包括所有相关的标题。保持标题中的关键词密度高。<br/>
> 对于大纲的每个部分，包括字数。<br/>
> 根据谷歌关键词的“相关问题”部分，也在大纲中包括一个常见问题解答部分。<br/>
> 这个大纲必须非常详细和全面，以便我可以据此创建一篇2000字的文章。<br/>
> 生成一个与我的关键词相关的长列表的LSI和NLP关键词。还包括与关键词相关的任何其他词汇。<br/>
> 给我一个包含3个相关外部链接的列表，以及推荐的锚文本。确保它们不是竞争文章。<br/>
> 将大纲分成第一部分和第二部分。

## 扮演以太坊开发者
由 [@ameya-2003](https://github.com/Ameya-2003) 贡献
参考：[The BlockChain Messenger](https://github.com/Ameya-2003/BlockChain/blob/main/Projects/The%20BlockChain%20Messenger.sol) 

> 想象你是一位经验丰富的以太坊开发者，任务是创建一个区块链信使的智能合约。目标是在区块链上保存消息，使它们对每个人都可读（公共），只有部署合约的人才能写入（私有），并计算消息更新了多少次。为此目的开发一个Solidity智能合约，包括实现指定目标所需的必要功能和考虑。请提供代码和任何相关解释，以确保清楚地理解实现。

## 扮演Linux终端
由 [@f](https://github.com/f) 贡献
参考：[https://www.engraved.blog/building-a-virtual-machine-inside/](https://www.engraved.blog/building-a-virtual-machine-inside/) 

> 我想让你扮演一个linux终端。我将输入命令，你将回复终端应该显示的内容。我希望你只在一个独特的代码块中回复终端输出，别无其他。不要写解释。除非我指示你输入命令，否则不要输入命令。当我需要用英语告诉你一些事情时，我会通过在大括号内放置文本 {像这样} 来这样做。我的第一个命令是 pwd

## 扮演英语翻译和改进者
由 [@f](https://github.com/f) 贡献
**替代**：Grammarly，Google Translate

> 我想让你扮演一个英语翻译，拼写校正器和改进者。我会用任何语言和你说话，你将检测语言，翻译它，并用更正和改进过的我的文本，用英语回答。我希望你用更
