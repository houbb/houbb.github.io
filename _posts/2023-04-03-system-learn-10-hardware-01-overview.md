---
layout: post
title: 操作系统学习-10-01-如何查看网络的性能指标？
...
![说明](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost3@main/%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F/%E6%B5%AE%E7%82%B9/%E5%B0%81%E8%A3%85.png)
...
![大纲](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost3@main/%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F/%E7%BD%91%E7%BB%9C/%E7%BD%91%E7%BB%9C%E6%8F%90%E7%BA%B2.png)
...
eth0: flags=4163<UP,BROADCAST,RUNNING,MULTICAST>  mtu 1500
        inet 10.64.8.14  netmask 255.255.252.0  broadcast 10.64.11.255
        ether 52:54:00:45:60:31  txqueuelen 1000  (Ethernet)
        RX packets 33587696  bytes 7971834407 (7.4 GiB)
        RX errors 0  dropped 0  overruns 0  frame 0
        TX packets 34718307  bytes 12723674347 (11.8 GiB)
...
2: eth0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc mq state UP group default qlen 1000
    link/ether 52:54:00:45:60:31 brd ff:ff:ff:ff:ff:ff
    inet 10.64.8.14/22 brd 10.64.11.255 scope global eth0
       valid_lft forever preferred_lft forever
    RX: bytes  packets  errors  dropped overrun mcast
    7975152336 33610020 0       0       0       0
    TX: bytes  packets  errors  dropped carrier collsns
    12731778358 34742915 0       0       0       0
```
...
```sh
# -n 不显示名称，用数字显示 IP + port
# -l 只显示 listen 状态的 socket
# -p 只显示进程信息

$ netstat -nlp
(No info could be read for "-p": geteuid()=3001 but you should be root.)
Active Internet connections (only servers)
Proto Recv-Q Send-Q Local Address           Foreign Address         State       PID/Program name
tcp        0      0 0.0.0.0:8956            0.0.0.0:*               LISTEN      -
tcp        0      0 0.0.0.0:32092           0.0.0.0:*               LISTEN      -
tcp        0      0 0.0.0.0:32126           0.0.0.0:*               LISTEN      -
```
...
![半链接和全连接](https://cdn.xiaolincoding.com/gh/xiaolincoder/ImageHost/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%BD%91%E7%BB%9C/TCP-%E5%8D%8A%E8%BF%9E%E6%8E%A5%E5%92%8C%E5%85%A8%E8%BF%9E%E6%8E%A5/3.jpg)
...
比如，如果要测试本机到 baidu.com IP 地址的连通性和延时：

```sh
# -c 5 标识发 5 次消息
$ ping baidu.com  -c 5
PING baidu.com (110.242.68.66) 56(84) bytes of data.
64 bytes from 110.242.68.66 (110.242.68.66): icmp_seq=1 ttl=48 time=26.1 ms
64 bytes from 110.242.68.66 (110.242.68.66): icmp_seq=2 ttl=48 time=26.1 ms
64 bytes from 110.242.68.66 (110.242.68.66): icmp_seq=3 ttl=48 time=26.0 ms
64 bytes from 110.242.68.66 (110.242.68.66): icmp_seq=4 ttl=48 time=26.1 ms
64 bytes from 110.242.68.66 (110.242.68.66): icmp_seq=5 ttl=48 time=26.1 ms

--- baidu.com ping statistics ---
5 packets transmitted, 5 received, 0% packet loss, time 4003ms
rtt min/avg/max/mdev = 26.077/26.108/26.132/0.205 ms
```
