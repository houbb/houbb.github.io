---
layout: post
title: cmdb-06-开源项目 webank/wecmdb
...
<img src="https://github.com/WeBankPartners/we-cmdb/raw/master/wiki/images/ci-data-management.gif" /> 
...
![WeCMDB系统架构](https://github.com/WeBankPartners/we-cmdb/raw/master/wiki/images/wecmdb_arch_cn.png) 
...
如何编译WeCMDB，请查看文档
[WeCMDB编译文档](https://github.com/WeBankPartners/we-cmdb/raw/master/wiki/docs/compile_guide.md)

如何安装WeCMDB， 请查看文档
[WeCMDB部署文档](https://github.com/WeBankPartners/we-cmdb/raw/master/wiki/docs/install_guide.md)

## 用户手册
关于WeCMDB模型说明， 请查看文档
[WeCMDB 模型说明手册](https://github.com/WeBankPartners/we-cmdb/raw/master/wiki/docs/wecmdb_model_guide.md)

关于WeCMDB的使用和操作说明， 请查看文档
[WeCMDB用户手册](https://github.com/WeBankPartners/we-cmdb/raw/master/wiki/docs/wecmdb_user_guide.md)

## 术语表
关于WeCMDB的使用到的术语，请查看文档
[WeCMDB 术语表](https://github.com/WeBankPartners/we-cmdb/raw/master/wiki/docs/manual/wecmdb_glossary.md)

## 版权声明

WeCMDB是基于 Apache License 2.0 协议， 详情请参考[LICENSE](LICENSE)
