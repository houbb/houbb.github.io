...
![解耦](https://github.com/doocs/advanced-java/raw/main/docs/high-concurrency/images/mq-1.png)
...
![mq2](https://github.com/doocs/advanced-java/raw/main/docs/high-concurrency/images/mq-2.png)
...
![异步](https://github.com/doocs/advanced-java/raw/main/docs/high-concurrency/images/mq-3.png)

一般互联网类的企业，对于用户直接的操作，一般要求是每个请求都必须在 200 ms 以内完成，对用户几乎是无感知的。

如果使用 MQ，那么 A 系统连续发送 3 条消息到 MQ 队列中，假如耗时 5ms，A 系统从接受一个请求到返回响应给用户，总时长是 3 + 5 = 8ms，对于用户而言，其实感觉上就是点个按钮，8ms 以后就直接返回了，爽！网站做得真好，真快！

![异步](https://github.com/doocs/advanced-java/raw/main/docs/high-concurrency/images/mq-4.png)
...
![削峰](https://github.com/doocs/advanced-java/raw/main/docs/high-concurrency/images/mq-5.png)
...
![削峰](https://github.com/doocs/advanced-java/raw/main/docs/high-concurrency/images/mq-6.png)
...
![mq-7.png](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/mq-7.png)
...
![mq-8.png](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/mq-8.png)
...
![kafka-before](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/kafka-before.png)
...
![kafka-after.png](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/kafka-after.png)
...
![mq-10.png](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/mq-10.png)
...
- 比如你不是上面两个场景，那做的稍微复杂一点，你需要让生产者发送每条数据的时候，里面加一个全局唯一的 id，类似订单 id 之类的东西，然后你这里消费到了之后，先根据这个 id 去比如 Redis 里
查一- 下，之前消费过吗？如果没有消费过，你就处理，然后这个 id 写 Redis。如果消费过了，那你就别处理了，保证别重复处理相同的消息即可。

- 比如基于数据库的唯一键来保证重复数据不会重复插入多条。因为有唯一键约束了，重复数据插入只会报错，不会导致数据库中出现脏数据。

![mq-11.png](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/mq-11.png)
...
![rabbitmq-message-lose](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/rabbitmq-message-lose.png)
...
![rabbitmq-message-lose-solution](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/rabbitmq-message-lose-solution.png)
...
- 在 Kafka 服务端设置 min.insync.replicas 参数：这个值必须大于 1，这个是要求一个 leader 至少感知到有至少一个 follower 还跟自己保持联系，没掉队，这样才能确保 leader 挂了还有一个 - 
follower 吧。
...
![rabbitmq-order-01.png](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/rabbitmq-order-01.png)
...
![kafka-order-01.png](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/kafka-order-01.png)
...
![rabbitmq-order-02](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/rabbitmq-order-02.png)
...
![Kafka](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/images/kafka-order-02.png)
...
[互联网 Java 工程师进阶知识完全扫盲](https://github.com/doocs/advanced-java/blob/main/docs/high-concurrency/why-mq.md)
