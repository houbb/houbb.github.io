---
layout: post
title: NET 网络专题汇总-08-断网了，还能 ping 通 127.0.0.1 吗？
...
![TCP发数据和ping的区别](https://cdn.xiaolincoding.com//mysql/other/eb0963a11439dff361dbe0e7a8876abd.png)
...
这也解释了**为什么当你发现怀疑网络有问题的时候，别人第一时间是问你能ping通吗？**
...
![PING](https://cdn.xiaolincoding.com//mysql/other/c1019a8be584b27c4fc8b8abda9d3cf1.png)
...
ping 回环地址和通过TCP等各种协议发送数据到回环地址都是走这条路径。整条路径从发到收，都没有经过"真网卡"。**之所以127.0.0.1叫本地回环地址，可以理解为，消息发出到这个地址上的话，就不会出网络，在本机打个转就又回来了。**
...
![ping](https://cdn.xiaolincoding.com//mysql/other/bc2765b1d6d3e37a5663f98085198926.png)

ping 本机地址:

![本机地址](https://cdn.xiaolincoding.com//mysql/other/50cd584f9f82aee8d3d9bfaf7d910cb8.png)
...
以前第一次用 nginx 的时候，发现用这几个 IP，都能正常访问到 nginx 的欢迎网页。
