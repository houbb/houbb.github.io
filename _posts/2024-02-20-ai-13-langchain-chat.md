...
![](https://github.com/chatchat-space/Langchain-Chatchat/blob/master/img/fastapi_docs_026.png)

2. Web UI 启动界面示例：

- Web UI 对话界面：

![img](https://github.com/chatchat-space/Langchain-Chatchat/blob/master/img/LLM_success.png)

- Web UI 知识库管理页面：

![](https://github.com/chatchat-space/Langchain-Chatchat/blob/master/img/LLM_success.png)
