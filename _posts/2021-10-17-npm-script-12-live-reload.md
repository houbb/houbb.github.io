...
于是社区里出现了 [LiveReload](https://www.npmjs.com/package/livereload) 来把这个过程自动化，react 种子项目生成工具 create-react-app 中就使用了这种技术。
...
使用如下命令安装 livereload 和 http-server 到项目依赖中：
...
https://www.kancloud.cn/sllyli/npm-script/1243459
