...
![client-request]({{ site.url }}/static/app/img/network/http/2017-04-21-client-request.png)
...
![server-response]({{ site.url }}/static/app/img/network/http/2017-04-21-server-response.jpg)
