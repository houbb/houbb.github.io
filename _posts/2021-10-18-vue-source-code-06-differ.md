...
![patch](https://img.kancloud.cn/78/ed/78ed0f7a71736796f0d4c31f5a9d1b9c_628x214.gif)
...
我们来逐步捋一下逻辑，addVnodes 、 removeVnodes 等函数后面会讲。
...
最后一种情况，当 oldVNode 与 vnode 都存在的时候，需要判断它们是否属于 sameVnode（相同的节点）。
...
之前patch的过程还剩下 patchVnode 这个函数没有讲，这也是最复杂的一个，我们现在来看一下。

因为这个函数是在符合 sameVnode 的条件下触发的，所以会进行「比对」。
...
下面的这种情况也比较简单，在当新老 VNode 节点都是 isStatic（静态的），并且 key 相同时，只要将 componentInstance 与 elm 从老 VNode 节点“拿过来”即可。
...
![differ-patch](https://img.kancloud.cn/9d/4a/9d4a83c7a917571940a8edd29396c345_885x397.gif)
...
![update-child-2](https://img.kancloud.cn/9b/fa/9bfa3d79db0aa810974ce4000e01ffd2_864x428.gif)
...
![updatenode-3](https://img.kancloud.cn/aa/8d/aa8d34c20a47b212378b1da678355af9_810x432.gif)
...
![update-3](https://img.kancloud.cn/e9/fa/e9fa09c72cbca2763a9fd891f8894d3c_750x373.gif)
...
![update-4](https://img.kancloud.cn/bc/0d/bc0dc37b80d324472e77d4eb418edf67_927x462.gif)
...
![update-5](https://img.kancloud.cn/9b/17/9b172cca47e698754c47653c10bc815f_784x373.gif)

同理，如果满足 newStartIdx > newEndIdx 条件，说明新节点比对完了，老节点还有多，将这些无用的老节点通过 removeVnodes 批量删除即可。

![update-6](https://img.kancloud.cn/37/65/3765205d0b78788b7cdddcffb70a495f_836x367.gif)
...
https://www.kancloud.cn/sllyli/vuejs/1244022
