---
layout: post
title: 飞致云的一些优秀开源项目介绍-03-JumpServer 一款开源的PAM工具(堡垒主机)
date: 2025-4-15 17:51:19 +0800
categories: [Github]
tags: [github, project, sh]
published: true
---
...
在浏览器中访问JumpServer `http://your-jumpserver-ip/`
- 用户名: `admin`
- 密码: `ChangeMe`
...
JumpServer由多个关键组件组成，这些组件共同构成JumpServer的功能框架，为用户提供全面的操作管理和安全控制能力。
...
- [maxkb](https://github.com/1Panel-dev/MaxKB/blob/main/README_CN.md) 是一款强大易用的企业级 AI 助手
...
https://github.com/jumpserver/jumpserver/blob/dev/readmes/README.zh-hans.md
