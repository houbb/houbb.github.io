...
![内存分配](https://cdn.xiaolincoding.com//mysql/other/e069da38c4b54ee98a585a176e2c342f.png)
...
![申请物理内存](https://cdn.xiaolincoding.com//mysql/other/2f61b0822b3c4a359f99770231981b07.png)
...
04:35:06 PM      0.00      0.00  12737.00      0.00   4728.00      0.00      0.00      0.00      0.00
04:35:07 PM      0.00   1668.00   2314.00      0.00    857.00      0.00      0.00      0.00      0.00
04:35:08 PM      0.00      0.00     21.00      0.00     38.00      0.00      0.00      0.00      0.00
04:35:09 PM      0.00    224.00   2201.00      0.00    820.00      0.00      0.00      0.00      0.00
```
...
![三个阈值](https://cdn.xiaolincoding.com//mysql/other/166bc9f5b7c545d89f1e36ab8dd772cf.png)
...
图中橙色部分：如果剩余内存（pages_free）在页低阈值（pages_low）和页最小阈值（pages_min）之间，说明内存压力比较大，剩余内存不多了。

这时 kswapd0 会执行内存回收，直到剩余内存大于高阈值（pages_high）为止。

虽然会触发内存回收，但是不会阻塞应用程序，因为两者关系是异步的。
...
![numa](https://cdn.xiaolincoding.com//mysql/other/feec409868070d8cd79aecad2895b531.png)
...
每个 Node 有自己独立的资源，包括内存、IO 等，每个 Node 之间可以通过互联模块总线（QPI）进行通信，所以，也就意味着每个 Node 上的 CPU 都可以访问到整个系统中的所有内存。
...
因此，zone_reclaim_mode 一般建议设置为 0。
...
我们可以在设置 -1000 到 1000 之间的任意一个数值，调整进程被 OOM Kill 的几率。
