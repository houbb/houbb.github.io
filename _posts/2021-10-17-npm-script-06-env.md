...
比如，我们在根目录下新建 coverage_archive 目录存储覆盖率归档，并利用变量机制把归档和版本号关联起来。
...
主要改动是：增加 cover:cleanup 和 cover:archive 命令，并且修改 postcover 命令。

下面对使用了环境变量的 npm script 稍作解释：
...
```
λ ls -a
./  ../  .editorconfig  .eslintrc.js  .gitignore  .markdownlint.json  .stylelintrc.js  index.js  package.json  package-lock.json  README.md  style.less  tests/
```
...
![cover:serve](https://img.kancloud.cn/00/69/00695251f600e394bf8a0bae7ec8bde5_1280x968.gif)

同时浏览器会打开覆盖率报告，如下图：

![cover](https://img.kancloud.cn/c1/45/c14577e3a5f47cf9ab7564ec22f21c6e_976x554.gif)

好，关于 npm script 里面的变量使用就介绍到这里，留给你的问题是，在你的项目里面怎么用起来呢？如果想到了，什么时候落地？

# 参考资料

https://www.kancloud.cn/sllyli/npm-script/1243455
