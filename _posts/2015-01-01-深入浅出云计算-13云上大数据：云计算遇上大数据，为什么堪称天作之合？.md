---
layout: post
title:  深入浅出云计算-13云上大数据：云计算遇上大数据，为什么堪称天作之合？
...
![](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e6%b7%b1%e5%85%a5%e6%b5%85%e5%87%ba%e4%ba%91%e8%ae%a1%e7%ae%97/assets/00d2acfd687db858e281f3f30edd1232.jpg)
...
![](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e6%b7%b1%e5%85%a5%e6%b5%85%e5%87%ba%e4%ba%91%e8%ae%a1%e7%ae%97/assets/43437ea49e14a956418dbe06ddf2b831.jpg)
...
[hadoop@ip-172-31-1-100 ~]$ hadoop fs -ls s3://geektime-hellocloud/ Found 1 items -rw-rw-rw- 1 hadoop hadoop 804335 2020-02-07 14:45 s3://geektime-hellocloud/ATaleOfTwoCities.txt
...
val book = sc.textFile("s3://geektime-hellocloud/ATaleOfTwoCities.txt") val wordCounts = book.flatMap(l => l.split(" ")).filter(_.length>0).map(w => (w, 1)).reduceByKey((a,b) => a+b) wordCounts.toDF("word", "count").write.parquet("s3://geektime-hellocloud/ATaleOfTwoCities-WordCount")

程序顺利执行后，由于我们把计算结果用 **Parquet列存储格式**，落地存储到了S3中，你可以到S3的相关界面里确认。在这里，你可以看到目录已经生成了：

![](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e6%b7%b1%e5%85%a5%e6%b5%85%e5%87%ba%e4%ba%91%e8%ae%a1%e7%ae%97/assets/39a6bb14680feb4a5740781a46038145.jpg)

点击进入目录，可以看到其中的Parquet文件，说明程序已经生成了结果：

![](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e6%b7%b1%e5%85%a5%e6%b5%85%e5%87%ba%e4%ba%91%e8%ae%a1%e7%ae%97/assets/60b3ffdcfa18174681145a280d37feb4.jpg)

为了证明结果的正确性，我们再使用另外一段Spark脚本，来读取刚才的结果文件，列出小说中出现频率最高的5个单词及出现次数：
scala> spark.read.parquet("s3://geektime-hellocloud/ATaleOfTwoCities-WordCount").orderBy(desc("count")).take(5).foreach(println) [the,7514] [and,4745] [of,4065] [to,3458] [a,2825]
...
CREATE DATABASE athenadb1; CREATE EXTERNAL TABLE athenadb1.wordcount_s3 ( word string, count int ) STORED AS PARQUET LOCATION 's3://geektime-hellocloud/ATaleOfTwoCities-WordCount';

然后，我们就可以在Athena的交互界面中轻松查询数据了。比如说，我们仍然查询小说中频率最高的5个单词，也可以通过SELECT语句很快得出结果：

![](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e6%b7%b1%e5%85%a5%e6%b5%85%e5%87%ba%e4%ba%91%e8%ae%a1%e7%ae%97/assets/adcb10a2e3d39438f70c61424c56e597.jpg)
...
create external schema athenadb1 from data catalog database 'athenadb1' iam_role 'arn:aws:iam::5085xxxx8040:role/mySpectrumRole'
...
create table wordcount distkey(word) sortkey(count) as select word, count from spectrum.wordCount_s3;
...
client@clientVM:~$ psql -h my-redshift-cluster-1.cwq9zgi6xxxx.us-west-1.redshift.amazonaws.com -d testdb1 -U awsuser -p 5439 -c "select /* from wordcount order by count desc limit 5;" word | count ------+------- the | 7514 and | 4745 of | 4065 to | 3458 a | 2825 (5 rows)
...
![](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e6%b7%b1%e5%85%a5%e6%b5%85%e5%87%ba%e4%ba%91%e8%ae%a1%e7%ae%97/assets/962906a5d783b32a332757126d475d30.jpg)
