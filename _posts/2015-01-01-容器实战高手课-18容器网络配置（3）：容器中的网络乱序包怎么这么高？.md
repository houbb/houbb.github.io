---
layout: post
title:  容器实战高手课-18容器网络配置（3）：容器中的网络乱序包怎么这么高？
...
iperf3
命令，向容器外部发送一下数据，从iperf3的输出”Retr”列里，我们可以看到有多少重传的数据包。

比如下面的例子里，我们可以看到有162个重传的数据包。
/# iperf3 -c 192.168.147.51 Connecting to host 192.168.147.51, port 5201 [ 5] local 192.168.225.12 port 51700 connected to 192.168.147.51 port 5201 [ ID] Interval Transfer Bitrate Retr Cwnd [ 5] 0.00-1.00 sec 1001 MBytes 8.40 Gbits/sec 162 192 KBytes … - - - - - - - - - - - - - - - - - - - - - - - - - [ ID] Interval Transfer Bitrate Retr [ 5] 0.00-10.00 sec 9.85 GBytes 8.46 Gbits/sec 162 sender [ 5] 0.00-10.04 sec 9.85 GBytes 8.42 Gbits/sec receiver iperf Done.
...
-bash-4.2/# nsenter -t 51598 -n netstat -s | grep retran 454 segments retransmited 442 fast retransmits -bash-4.2/# nsenter -t 51598 -n netstat -s | grep retran 616 segments retransmited 604 fast retransmits
...
![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/bc6a6059f49a5b61e95ba3705894b64b.jpeg)
...
![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/21935661dda5069f8dyy91e6cd5b295d.jpeg)
...
![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/2d61334e4066391ceeb90cac0bb25d55.jpeg)
...
-bash-4.2/# nsenter -t 51598 -n netstat -s | grep reordering Detected reordering 501067 times using SACK

**其实在云平台的这种网络环境里，网络包乱序+SACK之后，产生的数据包重传的量要远远高于网络丢包引起的重传。**

比如说像下面这张图里展示的这样，Seq 2与Seq 3这两个包如果乱序的话，那么就会引起Seq 2的立刻重传。

![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/a99709757a45279324600a45f7a44cd6.jpeg)
...
![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/c11581ec8f390b13ebc89fdb4cc2043b.jpeg)
...
![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/ea365c0d44625cf89c746d91799f9633.jpeg)
...
![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/e0413b74cbc1b5edcde5442fe94e11f9.jpeg)
...
/# cat /sys/devices/virtual/net/veth57703b6/queues/rx-0/rps_cpus 000 /# echo fff > /sys/devices/virtual/net/veth57703b6/queues/rx-0/rps_cpus /# cat /sys/devices/virtual/net/veth57703b6/queues/rx-0/rps_cpus fff
