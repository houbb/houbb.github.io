---
layout: post
title: sensitive-word-admin v2.0.0 全新 ui 版本发布！vue+前后端分离
...
[sensitive-word-admin](https://github.com/houbb/sensitive-word-admin) 最初的定位是让大家知道如何使用 [sensitive-word](https://github.com/houbb/sensitive-word)，所以开始想做个简单的例子。
...
![敏感词菜单](https://github.com/houbb/sensitive-word-admin/blob/master/sensitive-word-manager-menu.png?raw=true)
...
![接口验证](https://github.com/houbb/sensitive-word-admin/blob/master/sensitive-word-admin-api-test.png?raw=true)
