...
你可以使用 @vue/babel-preset-app 的 polyfills 选项预包含所需要的 polyfill。注意 es.promise 将被默认包含，因为现在的库依赖 Promise 是非常普遍的。
...
更多细节可查阅 [@babel/preset-env](https://cli.vuejs.org/zh/guide/browser-compatibility.html#usebuiltins-usage) 文档
