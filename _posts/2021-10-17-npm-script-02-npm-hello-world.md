...
执行上面第 3、4 行命令时结果是否符合预期？

如果不符合预期，请在下面留言，或者在读者群里反馈。
...
```
λ node_modules\.bin\eslint.cmd --init
```
...
此处选择默认的方式：To check syntax and find problems，日志如下：
...
npm WARN hello-npm-script@1.0.0 No description
npm WARN hello-npm-script@1.0.0 No repository field.

+ eslint-plugin-vue@7.19.1
added 12 packages from 7 contributors and audited 104 packages in 7.912s
...
Successfully created .eslintrc.js file in D:\code\hello-npm-script
```
...
> hello-npm-script@1.0.0 eslint D:\code\hello-npm-script
> eslint *.js
...
npm ERR! errno 1
npm ERR! hello-npm-script@1.0.0 eslint: `eslint *.js`
npm ERR! Exit status 1
npm ERR!
npm ERR! Failed at the hello-npm-script@1.0.0 eslint script.
npm ERR! This is probably not a problem with npm. There is likely additional logging output above.

npm ERR! A complete log of this run can be found in:
npm ERR!     C:\Users\Administrator\AppData\Roaming\npm-cache\_logs\2021-10-17T04_46_26_221Z-debug.log
```
