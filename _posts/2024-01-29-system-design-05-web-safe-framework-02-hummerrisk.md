---
layout: post
title: web safe framework-02-HummerRisk 是云原生安全平台，包括混合云安全治理和云原生安全检测。
...
![架构](https://github.com/HummerRisk/HummerRisk/blob/master/hummer-ui/src/assets/img/readme/architecturev.png)
...
* 对象存储: 同步云上对象存储桶资源，查看、上传、下载存储对象。根据对象存储安全与合规要求，快速检测并生成报告。
  ...
  ![混合云安全合规](https://github.com/HummerRisk/HummerRisk/blob/master/hummer-ui/src/assets/img/readme/multicloud.png)
...
* SBOM 管理: SBOM 的可视化管理和分析，检测 SBOM 的变更，快速发现和定位软件供应链中的风险和漏洞，给出合理地处理建议。
  ...
  ![容器云安全](https://github.com/HummerRisk/HummerRisk/blob/master/hummer-ui/src/assets/img/readme/k8s.png)
...
![UI 展示](https://github.com/HummerRisk/HummerRisk/blob/master/hummer-ui/src/assets/img/gif/hummerrisk.gif)
