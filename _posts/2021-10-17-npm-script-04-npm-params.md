...
```
λ npm run lint:js:fix

> hello-npm-script@0.1.0 lint:js:fix D:\code\hello-npm-script
> npm run lint:js -- --fix
...
问题来了，如果我想为 mocha 命令增加 --watch 模式方便在开发时立即看到测试结果，该怎么做呢？
...
这种做法能让 npm run 列出来的命令更美观，但是 scripts 声明阅读起来不那么整齐美观。
...
npm info lifecycle hello-npm-script@0.1.0~pretest: hello-npm-script@0.1.0
npm info lifecycle hello-npm-script@0.1.0~test: hello-npm-script@0.1.0

> hello-npm-script@0.1.0 test D:\code\hello-npm-script
> npm-run-all --parallel lint:* mocha

ERROR: Task not found: "mocha"
npm info lifecycle hello-npm-script@0.1.0~test: Failed to exec test script
npm ERR! Test failed.  See above for more details.
npm timing npm Completed in 576ms
```
