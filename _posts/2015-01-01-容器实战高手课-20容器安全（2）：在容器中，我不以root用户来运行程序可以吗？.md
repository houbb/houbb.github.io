---
layout: post
title:  容器实战高手课-20容器安全（2）：在容器中，我不以root用户来运行程序可以吗？
...
/# docker exec -it root_example bash -c "ps -ef | grep sleep" root 1 0 0 01:14 ? 00:00:00 /usr/bin/coreutils --coreutils-prog-shebang=sleep /usr/bin/sleep 3600 /# ps -ef | grep sleep root 5473 5443 0 18:14 ? 00:00:00 /usr/bin/coreutils --coreutils-prog-shebang=sleep /usr/bin/sleep 3600
...
/# tail -n 3 /etc/shadow grafana:!!:18437:::::: tcpdump:!!:18592:::::: hello
...
![img](https://learn.lianglianglee.com/%e4%b8%93%e6%a0%8f/%e5%ae%b9%e5%99%a8%e5%ae%9e%e6%88%98%e9%ab%98%e6%89%8b%e8%af%be/assets/647a11a38498128e0b00a48931e2f09c.jpg)
...
首先，我们先在容器中以用户uid 0运行一下

sleep
这个命令：
/# id uid=0(root) gid=0(root) groups=0(root) /# sleep 3600

然后就是第二步，到宿主机上查看一下这个进程的uid。这里我们可以看到，进程uid的确是2000了。

/# ps -ef |grep sleep 2000 27021 26957 0 01:32 pts/0 00:00:00 /usr/bin/coreutils --coreutils-prog-shebang=sleep /usr/bin/sleep 3600
