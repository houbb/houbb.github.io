...
![单页应用的基本配置](https://img.kancloud.cn/f0/a9/f0a9d8cb16d5788b1707115f63f157d4_565x308.gif)
...
![app.js](https://img.kancloud.cn/3b/33/3b3332cbada12b454faef17e019e7d27_809x87.gif)

但是优化过后，它们分别被拆分成了 2.js 和 3.js：

![app2.js](https://img.kancloud.cn/bb/f8/bbf831f35998fe5297150f734e51999b_813x107.gif)
...
除了 vue-router，如果你的项目需要用到 Vuex ，那么你应该对它有一定的了解，Vuex 是一个专为 Vue.js 应用程序开发的状态管理模式。
...
![module](https://img.kancloud.cn/24/b9/24b974c1f2dcb194c2adfb2effb1d98d_885x301.gif)
...
详细的案例代码可参考文末 github 地址。

# 3. 接口配置

在项目的开发过程中，我们也少不了与后台服务器进行数据的获取和交互，这一般都是通过接口完成的，那么我们如何进行合理的接口配置呢？
...
![304](https://img.kancloud.cn/3e/91/3e91ca8fee0ea466145f3f404129df9f_810x127.gif)
...
https://www.kancloud.cn/sllyli/vueproject/1244256
