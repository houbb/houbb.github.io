...
其他作者已经成功地使用神经网络或其他分类器，如支持向量机进行人脸检测[96]，[97]。他们的系统与上述系统非常相似，包括将图像以多种尺度呈现给网络的思想。但由于这些系统不使用卷积网络，它们无法利用此处描述的加速，并且必须依赖其他技术，如预过滤和实时跟踪，以保持合理范围内的计算要求。此外，因为这些分类器对尺度变化的不变性要远低于卷积网络，所以需要将图像呈现给分类器的尺度数量乘以。
