---
layout: post
title: Dubbo3.x-24-生态集成之 Dubbo 融合 Nacos 成为注册中心
...
![image-20181213103845976](https://cn.dubbo.apache.org/imgs/blog/dubbo-registry-nacos-1.png)

如图所示，服务名前缀为 `providers:` 的信息为服务提供者的元信息，`consumers:` 则代表服务消费者的元信息。点击"**详情**"可查看服务状态详情：

![image-20181213104145998](https://cn.dubbo.apache.org/imgs/blog/dubbo-registry-nacos-2.png)
...
xsi:schemaLocation="[http://www.springframework.org/schema/beans ](http://www.springframework.org/schema/beans )        [http://www.springframework.org/schema/beans/spring-beans-4.3.xsd ](http://www.springframework.org/schema/beans/spring-beans-4.3.xsd )        [http://dubbo.apache.org/schema/dubbo ](http://dubbo.apache.org/schema/dubbo )        [http://dubbo.apache.org/schema/dubbo/dubbo.xsd ](http://dubbo.apache.org/schema/dubbo/dubbo.xsd )">
...
![image-20181213113049185](https://cn.dubbo.apache.org/imgs/blog/dubbo-registry-nacos-3.png)
...
![image-20181213123909636](https://cn.dubbo.apache.org/imgs/blog/dubbo-registry-nacos-4.png)
...
更多内容请参考：https://github.com/apache/dubbo/tree/master/dubbo-registry/dubbo-registry-nacos。
