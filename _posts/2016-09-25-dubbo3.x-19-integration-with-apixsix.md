---
layout: post
title: Dubbo3.x-19-生态集成之使用 Apache APISIX 代理 Dubbo 服务（triple协议）
...
![](https://cn.dubbo.apache.org/imgs/v3/tasks/gateway/apisix-nacos-dubbo.png)
...
1.  在 [本地下载并启动 Nacos](/zh-cn/overview/reference/integrations/nacos/#%E6%9C%AC%E5%9C%B0%E4%B8%8B%E8%BD%BD)
...
如果您觉得 `/org.apache.dubbo.samples.gateway.apisix.DemoService/sayHello/` 这样的 http 端口对于网关访问不够友好，可参考 [为 triple 协议发布 rest 风格 http 接口](/zh-cn/overview/mannual/java-sdk/tasks/gateway/triple/#rest-%E9%A3%8E%E6%A0%BC%E6%8E%A5%E5%8F%A3)。
