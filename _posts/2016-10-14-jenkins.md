...
![jenkines]({{site.url}}/static/app/img/jenkins/2016-10-15-jenkins.png)
...
![tools]({{site.url}}/static/app/img/jenkins/2016-10-15-config-tools.png)
...
```/Users/houbinbin/.jenkins/workspace/framework``` 打开的路径,就是jenkins自带的 ```WORKSPACE```, 直接使用自测无效。愚蠢。。
